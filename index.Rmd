...
This book is intended as a short introduction to the R language. It covers the basics of R that are not covered by analysis and visualization guides like [R for Data Science](https://r4ds.had.co.na). Consider it a quick way to get up to speed on R before diving into the analysis and visualization aspects.
